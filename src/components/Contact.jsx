...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    console.log(import.meta.env.VITE_APP_TEST_VARIABLE)
    console.log(import.meta.env.VITE_APP_EMAIL_JS_PUBLIC_KEY)
    ...
    emailjs.send(
        ...
        import.meta.env.VITE_APP_EMAIL_JS_TEMPLATE_ID,
        {
          ...
          to_email: 'fagun.raithatha28@gmail.com',
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div
        ...
        className="flex-[0.75] bg-black-100 p-8 rouned-2xl"
      >
